...
function elite_book_now() {
    ...
    if (window.innerWidth >= 742) {
        if (_is_euro == '1' ) {
            ...
            jQuery('.header-inner #primary-menu').append('<li class="menu-item-book"><a href="https://pineapple.eliteislandvacations.com/" target="_blank" class="btn book-now main_booking_top_link" style="display: inline-block;">Book Now</a></li>');
        }
       ...
       /* jQuery('.main_booking_top_link').click(function(){
         ...
         if (_is_euro == '1' ) {
            jQuery('#primary-menu').append('<li class="menu-item-book"><a href="https://eliteislandholidays.com/book/main.aspx?Clear=True&resort=pineapple" target="_blank" class="btn book-now main_booking_top_link" style="display: block; text-align: center;">Book Now</a></li>');
        }
        else {
            jQuery('#primary-menu').append('<li class="menu-item-book"><a href="https://pineapple.eliteislandvacations.com/" target="_blank" class="btn book-now main_booking_top_link" style="display: block; text-align: center;">Book Now</a></li>');
