...
<div id="page" class="hfeed site">
	...
	<?php if ( get_theme_mod( 'liber_featured_slider_blog' )): ?>
		<div class="featured-slider">
			<?php // Show most recent posts.
				$recent_posts = new WP_Query( array(
					'posts_per_page'      => get_theme_mod( 'liber_featured_slider_post_number_blog' ),
					'category_name'       => get_theme_mod( 'liber_featured_slider_post_category_blog' ),
					'post_status'         => 'publish',
	...
	<?php endif; ?>
	<?php if ( get_theme_mod( 'liber_blog_title' )): ?>
